...
def start_menu(message_input: str, message_err: str, template: dict):
    ...
    menu_template = {
        0: (lambda: True, True),          # Пункт выхода из меню
        9: (lambda: print("exit"), True), # Пункт выхода из меню с сообщением
        2: (f, False),                    # Вызов функции f с возвращением в меню
        1: (f, True)}                     # Вызов функции f с выходом из меню
    """
    while True:
        # Ввод корректного ch
